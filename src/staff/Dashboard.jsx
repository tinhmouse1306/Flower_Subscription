...
const StaffDashboard = () => {
    ...
    useEffect(() => {
        // Mock data
        setStats([
            { title: 'Đơn hàng hôm nay', value: '25', icon: ShoppingCart, color: 'text-blue-600', bg: 'bg-blue-100' },
            { title: 'Đơn hàng đang giao', value: '8', icon: Truck, color: 'text-orange-600', bg: 'bg-orange-100' },
            { title: 'Đơn hàng đã hoàn thành', value: '120', icon: CheckCircle, color: 'text-green-600', bg: 'bg-green-100' },
            { title: 'Khách hàng cần hỗ trợ', value: '5', icon: AlertCircle, color: 'text-red-600', bg: 'bg-red-100' },
        ]);

        setTodayOrders([
            { id: 1, customer: 'Nguyễn Văn A', package: 'Gói Cơ Bản', status: 'pending', time: '09:00', address: '123 ABC, Q1, TP.HCM' },
            { id: 2, customer: 'Trần Thị B', package: 'Gói Premium', status: 'shipping', time: '10:30', address: '456 DEF, Q3, TP.HCM' },
            { id: 3, customer: 'Lê Văn C', package: 'Gói VIP', status: 'delivered', time: '11:15', address: '789 GHI, Q5, TP.HCM' },
            { id: 4, customer: 'Phạm Thị D', package: 'Gói Cơ Bản', status: 'processing', time: '14:00', address: '321 JKL, Q7, TP.HCM' },
            { id: 5, customer: 'Hoàng Văn E', package: 'Gói Premium', status: 'pending', time: '15:30', address: '654 MNO, Q10, TP.HCM' }
        ]);
    }, []);
